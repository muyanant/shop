    ...
    <script type="text/javascript">
        ...
        function delP() {
            ...
            if(param!=""){
                ...
                location.href="${pageContext.request.contextPath}/removeSelectProductsFromCart?"+param;

            }
        };
        //生成订单
        function createOrder(){
            location.href="${pageContext.request.contextPath}/jsp/order.jsp";
        }
    </script>
</head>
        ...
        <c:forEach items="${cart}" var="c">
            <tr>
                ...
                <td><a
                        ...
                        onclick="deleteProduct(event)"></a> <a href="javascript:void(0)"
...
<a href=${pageContext.request.contextPath}/default.jsp>回首页继续购物</a>
</body>
</html>
